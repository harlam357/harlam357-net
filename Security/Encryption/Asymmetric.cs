...
namespace harlam357.Security.Encryption
{
   ...
   public class Asymmetric
   {
      ...
      // Dynamic Key Container Name Fix
      //-- http://www.codeproject.com/Messages/2170836/Default-KeyContainerName.aspx
      ...
      private void LoadKeyXml(string keyXml, bool isPrivate)
      {
         ...
         catch (System.Security.XmlSyntaxException ex)
         {
            ...
            throw new System.Security.XmlSyntaxException(
      ...
      private RSACryptoServiceProvider GetRSAProvider()
      {
         ...
         catch (CryptographicException ex)
         {
            ...
            {
               throw new Exception(
                  "Unable to obtain Cryptographic Service Provider. " + "Either the permissions are incorrect on the " +
